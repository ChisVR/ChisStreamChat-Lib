...
class VimmChat extends events_1.EventEmitter {
    ...
    connect(channel) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                this.socket = new WebSocket(`wss://live.thencsshifters.chisdealhd.co.uk/entry`);
                this.socket.on("open", () => __awaiter(this, void 0, void 0, function* () {
                    this._connected = true;
                    const packet = {'type': 'PING'};
                    yield this.send(packet) && console.log("Connected to Chis Stream WSS Server.");
                    this.heartbeatTimer = setInterval(() => __awaiter(this, void 0, void 0, function* () { return yield this.send({'type': 'PING'}); }), 29 * 1000);
                    yield this.send(
						{'type': 'PING'})
                ...
                this.socket.on("message", (message) => {
                    ...
                    if(message == `{'type': 'PING'}`){ // Heart beat response.
                        if(this.debug == true){
    ...
    sendMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            const messageQuery = {"body":`${message}`,"author":"TheNCSShiftersBOT","type":"CHAT"};
